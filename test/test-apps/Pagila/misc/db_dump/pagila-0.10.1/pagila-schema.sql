...
--ALTER PROCEDURAL LANGUAGE plpgsql OWNER TO pagila;
...
ALTER TABLE public.payment_p2007_01 OWNER TO pagila;
...
ALTER TABLE public.payment_p2007_02 OWNER TO pagila;
...
ALTER TABLE public.payment_p2007_03 OWNER TO pagila;
...
ALTER TABLE public.payment_p2007_04 OWNER TO pagila;
...
ALTER TABLE public.payment_p2007_05 OWNER TO pagila;
...
ALTER TABLE public.payment_p2007_06 OWNER TO pagila;
...
ALTER FUNCTION public.get_customer_balance(p_customer_id integer, p_effective_date timestamp without time zone) OWNER TO pagila;
...
ALTER FUNCTION public.last_day(timestamp without time zone) OWNER TO pagila;
